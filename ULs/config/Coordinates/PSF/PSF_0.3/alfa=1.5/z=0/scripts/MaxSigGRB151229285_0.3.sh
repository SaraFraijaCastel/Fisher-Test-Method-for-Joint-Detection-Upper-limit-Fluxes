...
#SBATCH -o /lustre/hawcz01/scratch/userspace/jorgeamontes/GRB_KN/data/healpixz=0_alfa1.5/GRB151229285/GRB151229285/maps/codes/HIST.out
...
for Label in 1FINAL 2FINAL; do
    ...
    label2=${Label%%_*}
    output_file=/lustre/hawcz01/scratch/userspace/jorgeamontes/GRB_KN/data/ULs/config/Coordinates/PSF/PSF_0.3/alfa=1.5/z=0/SIG_ALL_GRBs/GRB151229285_PSF_0.3_Hist$Label.txt
    ...
    transit_file=/lustre/hawcz01/scratch/userspace/jorgeamontes/GRB_KN/data/healpixz=0_alfa1.5/GRB151229285/transit_${label2}/GRB151229285_transit_$Label.fits.gz

    PL=$(plotMercator.py "$transit_file" --magma --cross --circle $RA $DEC $Bin_size --circleproperty white 2 1 --origin $RA $DEC $Window_size $Window_size -o "/lustre/hawcz01/scratch/userspace/jorgeamontes/GRB_KN/data/ULs/config/Coordinates/PSF/PSF_0.3/alfa=1.5/z=0/SIG_ALL_GRBs/GRB151229285.png")
